...
dep_rabbit_common  = git-subfolder https://github.com/rabbitmq/rabbitmq-server v3.8.x deps/rabbit_common
dep_rabbit         = git-subfolder https://github.com/rabbitmq/rabbitmq-server v3.8.x deps/rabbit
